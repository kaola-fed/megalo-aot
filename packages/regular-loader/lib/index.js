...
module.exports = function (source) {
  ...
  if (!errorEmitted && !loaderContext['thread-loader'] && !loaderContext[NS]) {
    loaderContext.emitError(new Error(
      `regular-loader was used without the corresponding plugin. ` +
      `Make sure to include RegularLoaderPlugin in your webpack config.`
    ))
    errorEmitted = true
  }
  ...
  // e.g. foo.rgl?type=template&id=xxxxx
  ...
  if (descriptor.script) {
    ...
    const query = `?rgl&type=script${attrsQuery}${inheritQuery}`
...
var component = normalizer(
  ...
  // Expose filename. This is used by the devtools and Regular runtime warnings.
...
module.exports.RegularLoaderPlugin = plugin
